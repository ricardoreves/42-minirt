...
#    Updated: 2022/03/20 15:41:30 by rpinto-r         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_INC         = ./incs
SRCS_DIR         = ./srcs
SRCS_NAME        = main.c window.c image.c keyboard.c parsing.c parsing_utils.c parsing_utils2.c array_utils.c convert.c error.c file.c object_utils.c number.c debug.c test.c
