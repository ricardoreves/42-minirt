...
#    Updated: 2022/03/19 00:56:16 by rpinto-r         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_INC         = ./incs
SRCS_DIR         = ./srcs
SRCS_NAME        = main.c window.c image.c keyboard.c parsing.c array_utils.c convert.c error.c file.c object_utils.c number.c
